...
def setup_mnist(n_train=50000, n_val=10000, n_test=10000, batch_size=32, data_dir='data'):
    ...
    val_dataset = datasets.MNIST(data_dir, train=True, download=True, transform=transform)
